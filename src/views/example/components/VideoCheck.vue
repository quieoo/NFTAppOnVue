        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item style="margin-bottom: 40px;" prop="title">
              <MDinput>
                check the video uploaded to ipfs
              </MDinput>
            </el-form-item>
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item style="margin-bottom: 40px;" label-width="70px" label="CID:">
                    <el-input v-model="postForm.CID" :rows="1" type="textarea" class="article-textarea" autosize placeholder="Please enter the CID of video" />
                  </el-form-item>
            ...
            <el-container>
              <el-button :loading="loading" type="primary" style="width:5%;margin-bottom:30px;" @click.native.prevent="handlecheck">check</el-button>
            </el-container>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    handlecheck() {
      // window.location.href = 'http://localhost:8080/ipfs/' + this.postForm.CID
      window.open('http://localhost:8080/ipfs/' + this.postForm.CID)
    },
    async shell() {
